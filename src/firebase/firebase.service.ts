    ...
    if (!admin.apps.length) {
      this.app = admin.initializeApp({
        credential: admin.credential.cert({
          ...
          clientEmail: 'firebase-adminsdk-fbsvc@project-1532338643756643649.iam.gserviceaccount.com',
      ...
      console.log('✅ Firebase initialized with project:', 'project-1532338643756643649');
    }
  }
