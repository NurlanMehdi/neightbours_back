 ...
 */
export function votingOptionsTransformer({
  value,
}: TransformFnParams): { text: string }[] {
  console.log(
    'votingOptionsTransformer input:',
  ...
  if (value && typeof value === 'object' && !Array.isArray(value)) {
    ...
    console.log(
      'votingOptionsTransformer result:',
  ...
  if (Array.isArray(value)) {
    ...
    console.log(
      'votingOptionsTransformer array result:',
