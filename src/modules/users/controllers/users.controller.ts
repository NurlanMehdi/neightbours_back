...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Возвращает список УСПЕШНО подтвержденных объектов недвижимости (со статусом VERIFIED), которые подтвердил текущий пользователь. Объекты со статусом UNVERIFIED не возвращаются.',
  })
  @ApiResponse({
    status: 200,
